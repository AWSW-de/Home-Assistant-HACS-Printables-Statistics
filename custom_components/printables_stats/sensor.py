...
SENSORS: tuple[PrintablesSensorDescription, ...] = (
    ...
    PrintablesSensorDescription(
        key="published_models",
        translation_key="published_models",
        value_key="published_models",
        icon="mdi:printer-3d-nozzle",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="paid_models",
        translation_key="paid_models",
        value_key="paid_models",
        icon="mdi:currency-usd",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="store_models",
        translation_key="store_models",
        value_key="store_models",
        icon="mdi:store",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="published_edu_projects",
        translation_key="published_edu_projects",
        value_key="published_edu_projects",
        icon="mdi:school",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="published_articles",
        translation_key="published_articles",
        value_key="published_articles",
        icon="mdi:newspaper-variant-outline",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="likes_given_models",
        translation_key="likes_given_models",
        value_key="likes_given_models",
        icon="mdi:thumb-up-outline",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="likes_given_edu_projects",
        translation_key="likes_given_edu_projects",
        value_key="likes_given_edu_projects",
        icon="mdi:thumb-up-outline",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="likes_received_models",
        translation_key="likes_received_models",
        value_key="likes_received_models",
        icon="mdi:heart",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="makes",
        translation_key="makes",
        value_key="makes",
    ...
    PrintablesSensorDescription(
        ...
        value_key="collections",
        icon="mdi:folder-multiple-outline",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="club_members",
        translation_key="club_members",
        value_key="club_members",
        icon="mdi:account-group",
        state_class=SensorStateClass.TOTAL,
    ),
    PrintablesSensorDescription(
        key="profile_level",
        translation_key="profile_level",
        value_key="profile_level",
